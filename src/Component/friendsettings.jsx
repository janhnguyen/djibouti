           ...
           <div className='rightSetting'>
               ...
               <div className='accountInfo'>
                   <div className='settingsField' style={{alignContent: 'center'}}>
                       <label style={{marginLeft: '20px'}}>Blocked Users</label>
                   </div>
                   <div className='settingsField' style={{borderTop: "1px solid #b8b8b8", alignContent: 'center'}}>
                       <label style={{marginLeft: '20px'}}>View My Post</label>
                   </div>
                   <div className='settingsField' style={{borderTop: "1px solid #b8b8b8", alignContent: 'center'}}>
                       <label style={{marginLeft: "20px"}}>Contact Me</label>
                       <br/>
                   </div>
                   <div className='settingsField' style={{borderTop: "1px solid #b8b8b8", alignContent: 'center'}}>
                       <label style={{marginLeft: "20px"}}>Comments Settings</label>
                       <br/>
                   </div>
               </div>
               <button
