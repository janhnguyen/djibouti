           ...
           <div className='rightSetting'>
               ...
               <div className='accountInfo'>
                   <div className='settingsField' style={{alignContent: 'center'}}>
                       <label style={{marginLeft: '20px'}}>How do I delete my post?</label>
                   </div>
                   <div className='settingsField' style={{borderTop: "1px solid #b8b8b8", alignContent: 'center'}}>
                       <label style={{marginLeft: '20px'}}>How can I tag friends in comments?</label>
                   </div>
                   <div className='settingsField' style={{borderTop: "1px solid #b8b8b8", alignContent: 'center'}}>
                       <label style={{marginLeft: "20px"}}>Can I add friends to a group?</label>
                       <br/>
                   </div>
                   <div className='settingsField' style={{borderTop: "1px solid #b8b8b8", alignContent: 'center'}}>
                       <label style={{marginLeft: "20px"}}>How do I leave a group?</label>
                       <br/>
                   </div>
               </div>
               <button
